...
class CreditsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create credit" do
    assert_difference("Credit.count") do
      post credits_url, params: { credit: { credit_amount: @credit.credit_amount, customer_name: @credit.customer_name, sale_id: @credit.sale_id, total_amount: @credit.total_amount, total_received: @credit.total_received } }
    end
  ...
  test "should update credit" do
    patch credit_url(@credit), params: { credit: { credit_amount: @credit.credit_amount, customer_name: @credit.customer_name, sale_id: @credit.sale_id, total_amount: @credit.total_amount, total_received: @credit.total_received } }
